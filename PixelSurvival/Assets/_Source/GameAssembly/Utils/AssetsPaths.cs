namespace GameAssembly.Utils
{
    ...
    {
        public const string ITEM_CONFIGS_PATH = "Configs/Items";
        public const string BLOCK_CONFIGS_PATH = "Configs/Blocks";
        public const string RECIPES_CONFIGS_PATH = "Configs/Recipes";
        public const string SMELTING_RECIPES_CONFIGS_PATH = RECIPES_CONFIGS_PATH + "/Smelting";
