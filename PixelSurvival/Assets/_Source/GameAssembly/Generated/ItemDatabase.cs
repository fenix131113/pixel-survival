...
namespace GameAssembly.Generated
{
    public static class ItemDatabase
    {
        ...
        static ItemDatabase()
        {
            ...
            PurpleGrass = Resources.Load<ItemDefinitionSO>(AssetsPaths.ITEM_CONFIGS_PATH + "/PurpleGrass");
            RedBlock = Resources.Load<ItemDefinitionSO>(AssetsPaths.ITEM_CONFIGS_PATH + "/RedBlock");
            ...
            IronPlate = Resources.Load<ItemDefinitionSO>(AssetsPaths.ITEM_CONFIGS_PATH + "/IronPlate");
            Mystrium = Resources.Load<ItemDefinitionSO>(AssetsPaths.ITEM_CONFIGS_PATH + "/Mystrium");
