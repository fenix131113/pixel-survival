...
namespace Mirror
{
    ...
    {
        [Range(0, 60), Tooltip("Time interval in seconds between observer rebuilds")]
        public float rebuildInterval = 1;

        [Range(0, 60), Tooltip("Time interval in seconds between static object rebuilds")]
        public float staticRebuildInterval = 10;
